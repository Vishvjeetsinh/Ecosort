# `textile` training images

Put images of **textile** items in this folder (no sub-folders).

**What belongs here:** Clothes, shoes, towels, bedding, offcuts of fabric, belts, bags.

**Where to find images:** Not in TrashNet. The Kaggle 'Garbage Classification (12 classes)' set has `clothes` and `shoes` - merge both into this folder.
