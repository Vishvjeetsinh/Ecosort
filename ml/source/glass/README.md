# `glass` training images

Put images of **glass** items in this folder (no sub-folders).

**What belongs here:** Bottles, jars, drinking glasses, broken glass (photograph it safely).

**Where to find images:** TrashNet `glass` (~500 images).
