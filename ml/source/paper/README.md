# `paper` training images

Put images of **paper** items in this folder (no sub-folders).

**What belongs here:** Newspaper, magazines, office paper, envelopes, receipts, paper bags.

**Where to find images:** TrashNet `paper` (~590 images).
