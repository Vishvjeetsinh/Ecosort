# `plastic` training images

Put images of **plastic** items in this folder (no sub-folders).

**What belongs here:** PET bottles, tubs, yoghurt pots, bottle caps, film, bags, packaging trays.

**Where to find images:** TrashNet `plastic` (~480 images); TACO also has plastic-heavy annotations.
