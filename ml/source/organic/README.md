# `organic` training images

Put images of **organic** items in this folder (no sub-folders).

**What belongs here:** Food scraps, fruit and vegetable peel, coffee grounds, tea bags, eggshells, garden trimmings.

**Where to find images:** Kaggle 'Waste Classification data' (organic vs recyclable) and the `biological` class of the 12-class Garbage Classification set.
