# `hazardous` training images

Put images of **hazardous** items in this folder (no sub-folders).

**What belongs here:** Batteries, paint tins, aerosols with hazard symbols, solvents, light bulbs, fluorescent tubes, expired medicine, syringes.

**Where to find images:** Not in TrashNet. Kaggle 'Garbage Classification (12 classes)' has `battery`; photograph household chemicals for the rest.
