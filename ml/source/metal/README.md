# `metal` training images

Put images of **metal** items in this folder (no sub-folders).

**What belongs here:** Drink cans, food tins, aluminium foil, bottle caps, cutlery, empty aerosols.

**Where to find images:** TrashNet `metal` (~400 images).
