# `ewaste` training images

Put images of **ewaste** items in this folder (no sub-folders).

**What belongs here:** Phones, laptops, cables, chargers, remote controls, keyboards, circuit boards, printer cartridges, small appliances.

**Where to find images:** Not in TrashNet. The Kaggle 'E-Waste Image Dataset' and 'Garbage Classification (12 classes)' sets both cover it; own photos of your drawer of old cables work well.
